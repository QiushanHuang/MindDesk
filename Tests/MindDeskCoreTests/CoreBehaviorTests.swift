...
final class CoreBehaviorTests: XCTestCase {
    ...
    func testExternalActionPolicyNamesModalConfirmationSeparatelyFromUserMediation() {
        XCTAssertTrue(WorkbenchExternalActionPolicy.requiresModalConfirmation(.runCommand))
        XCTAssertTrue(WorkbenchExternalActionPolicy.requiresModalConfirmation(.openTerminal))
        XCTAssertFalse(WorkbenchExternalActionPolicy.requiresModalConfirmation(.openURL))
        XCTAssertFalse(WorkbenchExternalActionPolicy.requiresModalConfirmation(.openFileSystemItem))
        XCTAssertFalse(WorkbenchExternalActionPolicy.requiresModalConfirmation(.copyPathToClipboard))
