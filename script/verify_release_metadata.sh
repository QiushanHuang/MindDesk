...
require_contains "$README" "MindDesk-v$VERSION-macOS-arm64-adhoc.dmg"
require_contains "$README" "MindDesk-v$VERSION-macOS-arm64-adhoc.zip"
...
require_contains "$RELEASE_NOTES" "## Installation"
require_contains "$RELEASE_NOTES" "## Verification"
